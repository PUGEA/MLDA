...
def gene_expre(geneFile,data_path,condition,replicate,output_path):
	...
	output_path=os.path.join(output_path,'LR0_result')
...
#lda_expre('/home/tutut/MLDA/software/MLDA/geneFileS','/home/tutut/MLDA/software/MLDA/Result/workfloder',4,1,'/home/tutut/MLDA/software/MLDA/Result')
